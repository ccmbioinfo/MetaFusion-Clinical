...
class FusionResult():
    def __init__(self, tool, line, idxes):
        ...
        self.tool = tool
        # DRAGEN
        #MAF--RP11-679B19.2  0.687111    chr16:79619740:-    chr16:79246798:-    ENSG00000178573.6   ENSG00000261722.1   1   0   1   M70292:226:000000000-JG5LD:1:2101:16221:13209;M70292:226:000000000-JG5LD:1:1118:25958:17836;
        ...
        # STAR-FUSION NEEDS FIELDS ASSIGNED DIFFERENTLY
            ...
            sys.stderr.out("TOOL NOT RECOGNIZED")
            exit(1)
            self.chr1 = tmp[idx_chr1]
            self.pos1 = tmp[idx_pos1]
            self.strand1 = tmp[idx_strand1] if idx_strand1 != "NA" else "NA" 
...
class FusionResultFile():
    def __init__(self, result_file):
        ...
        for line in open(result_file, "r"):
            #print(line)
            tmp = line.split()
            #FusionGene	Score	LeftBreakpoint	RightBreakpoint	Gene1Id	Gene2Id	NumSplitReads	NumSoftClippedReads	NumPairedReads	ReadNames
    ...
    def __init__(self, sampleinfo_file):
        ...
        for line in open(sampleinfo_file, "r"):
            ...
            if tmp[0] == "sample": ## header
                ...
                #self.sampleinfo_dict.sample = tmp[0]
                #self.sampleinfo_dict.disease = tmp[1]
                #self.sampleinfo_dict.sample_type = tmp[2]
...
for fusion in fusion_results:
    ...
    print >> out_file, "\t".join(map(str, [fusion.chr1, fusion.pos1, fusion.strand1, fusion.chr2, fusion.pos2, fusion.strand2, fusion.frame, sample, sample_type, disease_name, args.tool, fusion.split_cnt, fusion.pair_cnt, \
