...
sampleinfo=/MetaFusion/test_data/sampleinfo.dragen
...
outdir=/MetaFusion/test_data/trusight_cff/dragen_cff
#outdir=/MetaFusion/Sandbox
...
for result_file in ${result_files[@]};do
  ...
  echo python convert_fusion_results_to_cff.py --sample $sample --sample_info_file $sampleinfo --tool $tool --fusion_result_file $result_file  --outdir $outdir
  python convert_fusion_results_to_cff.py --sample $sample --sample_info_file $sampleinfo --tool $tool --fusion_result_file $result_file  --outdir $outdir
done
